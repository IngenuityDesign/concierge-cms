...
var optimizeHtmlTask = function(src, dest) {
  ...
  gulp.task('less', function() {
   gulp.src('./app/styles/main.less')
      .pipe(less({
        paths:['.app/styles/less/theme','.app/styles/less']
      }))
...
gulp.task('serve', ['lint', 'less','styles', 'elements', 'images'], function() {
  browserSync({
    port: 5000,
    notify: false,
    logPrefix: 'PSK',
  ...
  gulp.watch(['app/styles/**/*.less'], ['less', 'styles', reload]);
